...
mcmcCoda = genMCMC( data=datamath1 , numSavedSteps=10000 , saveName=fileNameRoot )
#------------------------------------------------------------------------------- 
...
plotMCMC( mcmcCoda , data=datamath1 , # compVal=0.5 , rope=c(0.45,0.55) ,
          saveName=fileNameRoot ,  diffIdVec=list( c("theta[i]","theta[i]") ),
          compValDiff=0.0, saveType=graphFileType )
#------------------------------------------------------------------------------- 
